...
This repository publishes importable n8n workflows and portable AI-agent skills for the [ScoutingAPI](https://scoutingapi.com) accommodation-data API. Pull requests are welcome.
