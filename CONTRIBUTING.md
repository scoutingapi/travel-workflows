...
This repository publishes importable n8n workflows and portable AI-agent skills for the [StayingAPI](https://stayingapi.com) accommodation-data API. Pull requests are welcome.
