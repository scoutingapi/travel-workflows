...
- [Agent-native scouting via MCP](mcp-agent-scouting.md) — Connect StayingAPI as a Claude/Cursor MCP connector and scout stays, compare prices and check availability conversationally — no keys pasted.
